...
<div class="page-content fade-in-up">
    ...
    <div class="ibox-head">
        ...
        <div class="ibox-title text-left"><a href="{{url('/variation/create')}}"><button class="btn btn-primary btn-md">Add New variation</button></a></div>
    </div>
    <div class="ibox-body">
        <form method="get" action="{{url('search_variation')}}">
            @csrf
            <div class="d-flex">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$d->variation_name}}</td>

                        <td class="d-flex">
                            <a href="{{url('variation/'.$d->variation_id.'/edit')}}"><button class="btn btn-default btn-xs mr-2" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil font-14"></i></button></a>

                            <form method="post" action="{{url('variation/'.$d->variation_id)}}">
                                @csrf
                                @method('DELETE')
